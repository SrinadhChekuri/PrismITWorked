 ...
 */
public class UpdateRegistertable {
	...
	public static void main(String[] args) {
		...
		System.out.println("Updating values into registration table");
		stmt=con.createStatement();
		String sql="Update registration set first='robert',last='white',age=67 where id=2";
		stmt.executeUpdate(sql);
		System.out.println("Updated values into registration table");
